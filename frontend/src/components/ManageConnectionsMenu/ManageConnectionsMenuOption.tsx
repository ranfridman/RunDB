...
import { Avatar, Button, Dialog, Menu, Text, TextInput, ThemeIcon } from "@mantine/core"
import { Check, Group, Pencil, Trash } from "lucide-react"
        ...
        <>
            <Menu.Sub openDelay={120} closeDelay={150} offset={10} position="left-start">
                ...
                <Menu.Sub.Dropdown color="dark" >
                    ...
                    <Menu.Item closeMenuOnClick c="" py={3} mb={5} onClick={() => setDBModal(dbConnectionId)} leftSection={<Pencil size={14} />}>Edit Properties</Menu.Item>
                    <Menu.Item color="red" py={3} mb={5} leftSection={<Trash size={14} />} onClick={open}>Remove Connection</Menu.Item>
                </Menu.Sub.Dropdown>
            </Menu.Sub>
        </>
    )
